            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                {
                    doctors.map(doctor => <div key={doctor.id} className="w-[411px] h-[563px] bg-white rounded-xl shadow-md flex flex-col items-center p-4">
                        ...
                        <NavLink to={"/DoctorDetails"}>
                            <a className=" mt-2.5 relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-indigo-600 border-2 border-indigo-600 rounded-full hover:text-white group hover:bg-gray-50">
